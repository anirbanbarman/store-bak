...
export interface ParameterModal {
  title:string;
  message:string;
  data:any;
}
@Component({
    selector: 'parametermodal',
    templateUrl:'./parametermodal.component.html'
})
export class ParameterModalComponent extends SimpleModalComponent<ParameterModal, any> implements ParameterModal {
  title !: string;
  message !: string;
  data !:any;
  page: number = 1;
